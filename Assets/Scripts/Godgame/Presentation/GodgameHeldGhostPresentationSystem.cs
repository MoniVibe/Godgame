...
namespace Godgame.Presentation
{
    ...
    /// <summary>
    /// Ghosts held entities by lowering their alpha while the divine hand is holding them.
    /// </summary>
    [BurstCompile]
    [UpdateInGroup(typeof(PresentationSystemGroup), OrderLast = true)]
    [UpdateAfter(typeof(Godgame_ExpiryHintPresentationSystem))]
    [UpdateBefore(typeof(Godgame_RenderTintSyncSystem))]
    public partial struct GodgameHeldGhostPresentationSystem : ISystem
    {
