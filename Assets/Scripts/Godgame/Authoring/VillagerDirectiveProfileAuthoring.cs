...
namespace Godgame.Authoring
{
    ...
    public sealed class VillagerDirectiveProfileAuthoring : MonoBehaviour
    {
        ...
        private sealed class Baker : Baker<VillagerDirectiveProfileAuthoring>
        {
            public override void Bake(VillagerDirectiveProfileAuthoring authoring)
            {
                var entity = GetEntity(TransformUsageFlags.Dynamic);
                AddComponent(entity, new VillagerDirectiveProfile
                {
