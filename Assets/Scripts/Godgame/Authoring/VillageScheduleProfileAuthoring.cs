...
{
    /// <summary>
    /// Authoring for village schedule profile overrides.
    /// </summary>
    [DisallowMultipleComponent]
    public sealed class VillageScheduleProfileAuthoring : MonoBehaviour
    {
        [Range(0f, 1f)] public float villageWeight = 1f;
        ...
        private sealed class Baker : Baker<VillageScheduleProfileAuthoring>
        {
            public override void Bake(VillageScheduleProfileAuthoring authoring)
            {
                var entity = GetEntity(TransformUsageFlags.None);
                AddComponent(entity, new VillageScheduleProfile
                {
                    Weight = Mathf.Clamp01(authoring.villageWeight),
