...
{
    /// <summary>
    /// Ensures the canonical star + world planetoid entities exist for Godgame scenarios.
    /// </summary>
    [UpdateInGroup(typeof(InitializationSystemGroup))]
    [UpdateAfter(typeof(PureDOTS.Systems.CoreSingletonBootstrapSystem))]
    public partial struct GodgameCelestialBootstrapSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            entityManager.AddComponentData(world, LocalTransform.FromPosition(float3.zero));
