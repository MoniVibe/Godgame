...
{
    internal static class GodgameHeadlessDiagnostics
    {
        ...
        public static void InitializeFromArgs()
        {
            ...
            {
                UnityDebug.LogWarning("[GodgameHeadlessDiagnostics] --outDir missing; diagnostics disabled.");
                Enabled = false;
                return;
            }
        ...
        public static void ShutdownWriter(int timeoutMs = DefaultFlushTimeoutMs)
        {
            ...
            {
                UnityDebug.LogWarning("[GodgameHeadlessDiagnostics] Progress writer flush exceeded timeout; abandoning remaining writes.");
            }
        }
        ...
        private static void EnsureWriter()
        {
            ...
            {
                IsBackground = true,
                Name = "GodgameHeadlessDiagWriter"
            };
        ...
        private static void EnqueueWrite(string path, string payload)
        {
            ...
            if (depth > ProgressQueueLimit)
            {
                ...
                {
                    UnityDebug.LogWarning("[GodgameHeadlessDiagnostics] Progress writer queue full; dropping updates.");
                }
                return;
            }
        ...
        private static void TryWriteAtomic(string path, string payload)
        {
            ...
            {
                UnityDebug.LogWarning($"[GodgameHeadlessDiagnostics] Failed to write diagnostics file '{path}': {ex.Message}");
            }
        }
            ...
            uint lastTick)
        {
            ...
            var determinismHash = ComputeDeterminismHash(scenario, seed, simTicks,
                entityCountPeak, allocBytesPeak, avgDtMs, invariants);
