...
namespace Godgame.Registry
{
    ...
    public partial struct GodgameRegistryBridgeSystem : ISystem
    {
        ...
        private EntityQuery _logisticsQuery;
        ...
        public void OnCreate(ref SystemState state)
        {
            ...
            _logisticsQuery = SystemAPI.QueryBuilder()
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            UpdateLogisticsRegistry(ref state);
        ...
        private void UpdateMiracleRegistry(ref SystemState state, ref BridgeSummary summary)
        {
                         ...
                         .WithEntityAccess())
            {
                ...
                if (runtime.ValueRO.Lifecycle == MiracleLifecycleState.Cooldown)
                {
        ...
        private void UpdateLogisticsRegistry(ref SystemState state)
        {
            ...
            if (metadata.ArchetypeId == 0)
            {
                metadata.ArchetypeId = GodgameRegistryIds.LogisticsRequestArchetype;
            }

            // Registry entries are built by LogisticsRequestRegistrySystem; no additional buffering required here.
        }
    ...
    public partial struct GodgameRegistryTelemetrySystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            buffer.Add(new TelemetryMetric { Key = MetricMiracleCooldown, Value = snapshot.TotalMiracleCooldownSeconds, Unit = TelemetryMetricUnit.DurationMilliseconds });
