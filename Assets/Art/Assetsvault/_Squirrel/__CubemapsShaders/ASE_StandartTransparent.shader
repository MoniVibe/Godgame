...
Shader "ASE/ASE_StandartTransparent"
{
	Properties
	{
		...
		[ASEEnd]_CubemapInens("CubemapInens", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 worldRefl73 = reflect( -V, float3( dot( tanToWorld0, tex2DNode13 ), dot( tanToWorld1, tex2DNode13 ), dot( tanToWorld2, tex2DNode13 ) ) );
				...
				float2 clipScreen115 = ase_screenPosNorm.xy * _ScreenParams.xy;
				float dither115 = Dither8x8Bayer( fmod(clipScreen115.x, 8), fmod(clipScreen115.y, 8) );
				dither115 = step( dither115, ( tex2DNode1.a * _AlbedoColor.a ) );
				...
				surfaceDescription.Emission = ( ( ( _CubemapInens * ( texCUBE( _Cubemap, worldRefl73 ) * _CubemapColor ) ) * (( _SmoothRough )?( ( 1.0 - (( _SmoothFromMapSwitch )?( tex2D( _SmoothnessMap, uv_SmoothnessMap ).r ):( tex2DNode5.a )) ) ):( (( _SmoothFromMapSwitch )?( tex2D( _SmoothnessMap, uv_SmoothnessMap ).r ):( tex2DNode5.a )) )) ) + ( _EmissionColor * ( _EmissionMultiplayer * (( _EmissionSwitch )?( ( temp_output_3_0 * float4( 0,0,0,0 ) * tex2DNode33.a ) ):( tex2DNode33 )) ) ) ).rgb;
				...
				surfaceDescription.Alpha = dither115;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_Albedo = packedInput.ase_texcoord.xyz.xy * _Albedo_ST.xy + _Albedo_ST.zw;
				float4 tex2DNode1 = tex2D( _Albedo, uv_Albedo );
				float4 temp_output_3_0 = ( tex2DNode1 * _AlbedoColor );
				
				float2 uv_NormalMap = packedInput.ase_texcoord.xyz.xy * _NormalMap_ST.xy + _NormalMap_ST.zw;
				float3 unpack13 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), _NormalMapDepth );
				unpack13.z = lerp( 1, unpack13.z, saturate(_NormalMapDepth) );
				float3 tex2DNode13 = unpack13;
				
				float2 uv_MetallicMap = packedInput.ase_texcoord.xyz.xy * _MetallicMap_ST.xy + _MetallicMap_ST.zw;
				float4 tex2DNode5 = tex2D( _MetallicMap, uv_MetallicMap );
				...
				float2 uv_SmoothnessMap = packedInput.ase_texcoord.xyz.xy * _SmoothnessMap_ST.xy + _SmoothnessMap_ST.zw;
...
/*ASEBEGIN
Version=18900
132.6667;538.6667;1514.667;1233.667;1167.932;1015.944;1.6;True;False
Node;AmplifyShaderEditor.RangedFloatNode;66;-1428.504,-467.3266;Float;False;Property;_NormalMapDepth;NormalMapDepth;17;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;4;-407.9034,-673.7851;Float;False;Property;_AlbedoColor;AlbedoColor;3;0;Create;True;0;0;0;False;0;False;1,1,1,1;0.6415094,0.6415094,0.6415094,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;13;-778.8251,-414.4076;Inherit;True;Property;_NormalMap;NormalMap;8;0;Create;True;0;0;0;False;0;False;-1;None;0c6d0ad8c6218164cace45cbefa4b826;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1;-549.0192,-948.9838;Inherit;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;0;False;0;False;-1;None;a837203c6c392844b9a0d86270937856;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;33;-429.1485,-441.8334;Inherit;True;Property;_EmissionMap;EmissionMap;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;6;-1291.196,248.5266;Inherit;True;Property;_SmoothnessMap;SmoothnessMap;13;0;Create;True;0;0;0;False;0;False;-1;None;a3ba8151873004549a6bdcca08536d0d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;80;110.8052,-956.5374;Float;False;Property;_CubemapColor;CubemapColor;5;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;77;97.92907,-1328.744;Float;False;Property;_CubemapInens;CubemapInens;18;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;32;280.0221,-432.5562;Float;False;Property;_EmissionSwitch;EmissionSwitch;11;0;Create;True;0;0;0;False;0;False;1;True;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;39;664.2116,-484.477;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;36;416.9641,-884.3021;Float;False;Property;_EmissionColor;EmissionColor;6;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;114;579.4788,-232.7131;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;37;774.5065,-730.8632;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;74;966.4941,-631.2875;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;68;109.0028,-183.2273;Float;False;Property;_TransparentSwitch;TransparentSwitch;10;0;Create;True;0;0;0;False;0;False;1;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DitheringNode;115;789.0291,-237.8062;Inherit;False;1;False;4;0;FLOAT;0;False;1;SAMPLER2D;;False;2;FLOAT4;0,0,0,0;False;3;SAMPLERSTATE;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;82;401.3302,-147.9863;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;114;0;1;4
WireConnection;114;1;4;4
...
WireConnection;103;1;13;0
WireConnection;103;4;7;0
WireConnection;103;6;74;0
WireConnection;103;7;10;0
WireConnection;103;9;115;0
ASEEND*/
//CHKSM=C674EDE5C2E893674BA277862F06C297421F6A3D