...
namespace Tri.BuildTools
{
    public static class HeadlessLinuxBuild
    {
        ...
        private static void WriteBuildReport(BuildReport report, string jsonPath, string textPath)
        {
            ...
            AppendJsonField(sbJson, "total_time_seconds", summary.totalTime.TotalSeconds.ToString("F2", CultureInfo.InvariantCulture), prependComma: true, quote: false);
            sbJson.Append("},");
            sbJson.Append("\"steps\":[");
            ...
            foreach (var step in report.steps)
            {
                ...
                AppendJsonField(sbJson, "duration_seconds", step.duration.TotalSeconds.ToString("F2", CultureInfo.InvariantCulture), prependComma: true, quote: false);
        ...
        private static string ResolveEntrypointPath(BuildReport report, string buildOut)
        {
            ...
            return Path.Combine(buildOut, "Godgame_Headless.x86_64");
        }
