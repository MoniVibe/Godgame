...
- **Time/Rewind**: `TimeState`, `RewindState`, snapshot/command log (`Packages/com.moni.puredots/Runtime/Time`). Godgame legacy runtime in `Assets/Scripts/Godgame/Time/`; determinism tests live under `Assets/Scripts/Godgame/Tests`.
